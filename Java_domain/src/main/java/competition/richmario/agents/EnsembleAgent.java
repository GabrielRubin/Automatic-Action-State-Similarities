...
import competition.richmario.AutoEncoderCommunicator;
...
abstract public class EnsembleAgent extends BasicMarioAIAgent implements Agent {
    ...
    public AutoEncoderCommunicator m_AECommunicator;
    ...
    public EnsembleAgent(Logger logger, QLambdaAgent[] agents, double epsilon, boolean recording){
        ...
        //this.m_AECommunicator = new AutoEncoderCommunicator();
...
//        action[Mario.KEY_SPEED] = action[Mario.KEY_JUMP] = isMarioAbleToJump || !isMarioOnGround;
    ...
    public void giveIntermediateReward(float reward) {
        ...
        //m_AECommunicator.SendMsg(sa.toString());
        ...
        if(SimpleExperiment.usingSimilarities != 2) {
            ...
            for (QLambdaAgent agent : agents) {
                ...
                //List<Pair<StateAction, Double>> similarities = SimilarityManager.GetSimilaritiesViaCommunicator(prevSA, agent);
                List<Pair<StateAction, Double>> similarities = SimilarityManager.GetSimilaritiesViaDL4J(prevSA, agent);
